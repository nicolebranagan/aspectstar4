    ...
    update(options : LevelOptions) {
        ...
        if (this.frameTimer > 8) {
            ...
            this.sprite.texture.frame = new PIXI.Rectangle(
                ...
                this.aspect !== player.aspect ? this.spriteFrame.y : this.spriteFrame.y + this.spriteFrame.height,
        ...
        if (this.timer > 2*this.dist) {
            ...
            this.point = this.physics.step(this.point, this.aspect, objects, this, delta);
        } else {
            const delta = new Point(1, 0);
            this.point = this.physics.step(this.point, this.aspect, objects, this, delta);
        }
